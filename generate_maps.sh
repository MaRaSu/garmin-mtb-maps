...
create_map 24.37 60.12 25.28 60.41 TK_pathsonly "Helsinki region" TK_Helsinki 88990012 tk_hki_paths.img
create_map 24.50 64.70 26.20 65.25 TK_pathsonly "Oulu region" TK_Oulu 89000013 tk_oulu_paths.img
create_map 24.98314 60.87659 26.28208 61.37907 TK_pathsonly "Lahti region" TK_Lahti 89010014 tk_lahti_paths.img
create_map 21.20 60.70 23.00 61.70 TK_pathsonly "Eura Pori Rauma region" TK_Eura 89020015 tk_eura_paths.img
create_map 27.30 62.70 28.10 63.20 TK_pathsonly "Kuopio region" TK_Kuopio 89030016 tk_kuopio_paths.img
create_map 29.02 65.36 29.74 65.58 TK_pathsonly "Hossa region" TK_Hossa 89040018 tk_hossa_paths.img
create_map 27.41 65.52 27.91 65.81 TK_pathsonly "Syote region" TK_Syote 89050019 tk_syote_paths.img
create_map 23.35 67.39 25.12 68.42 TK_pathsonly "Levi Ylläs" TK_Yllas 89060020 tk_yllas_paths.img 

create_map 21.00 59.75 31.60 70.08 TK_pathsonly "Finland" TK_Finland 89070017 tk_finland_paths.img
